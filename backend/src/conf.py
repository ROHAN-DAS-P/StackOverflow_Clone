"""
Django settings for StackOverflow backend project.
"""
import os
...
MIDDLEWARE = [
    ...
    'src.middleware.logging.RequestLoggingMiddleware',
    'src.middleware.error.ErrorHandlingMiddleware',
    'src.middleware.rate_limit.RateLimitMiddleware',
]

ROOT_URLCONF = 'src.routes.urls'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'src.middleware.auth.JWTAuthentication',
    ),
